  ...
  return (
    <div className="text-page">
      ...
      <p>
        ...
        comercialmente aceitáveis ​​para evitar perdas
      ...
      <p>
        ...
        que não são operados por nós. Esteja ciente de
        que não temos controle sobre o conteúdo e práticas
        desses sites e não podemos aceitar responsabilidade
      ...
      <p>
        ...
        de nossas práticas em torno de privacidade
        e informações pessoais. Se você tiver alguma dúvida sobre como lidamos com dados
      ...
      <ul>
        <li>
          Os
          dados dos usuários não são acessíveis por quem criou a aplicaçã,
          e sim, somente pela empresa Google

        </li>
        <li>
          O funcionamento da API é monitorado pelo
          {' '}
      ...
      <h3>Trybe</h3>
      <p>
        Esta aplicação não pertence a
        instituição Trybe, apenas é uma ferramenta criada por um aluno,
        mantida de forma gratuita pelo Vercel e criada com o intuito de ajudar
        os alunos a receberem lembretes das aulas e momentos síncronos da Trybe
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          {' '}
          <a href="https://ondeapostar.pt/review/betano/">betano pt</a>
          {' '}
      ...
      <p>
        ...
        é mais seguro deixar os cookies ativados, caso interaja com um dos recursos
